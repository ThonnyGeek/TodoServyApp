...
struct Business: Identifiable/*, Codable*/ {
    ...
    init(id: Int, name: String, about: String, cellphone: String, picture: UIImage, rate: Int, stars: [String]) {
        self.id = id
        self.name = name
        self.about = about
